...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("2 - Показати студентів/викладачів");
            System.out.println("3 - Змінити дані");
            System.out.println("4 - Видалити студента/викладача");
            System.out.println("5 - Пошук студента/викладача за іменем, прізвищем та по батькові");
            System.out.println("6 - Пошук студента за курсом");
            System.out.println("7 - Пошук студента за групою");
            System.out.println("8 - Сортування студентів за групами");
            ...
            switch (choice) {
                    ...
                    if(choice == 2){
                        ...
                        while (position == null) {
                            System.out.println("Введіть посаду викладача (Професор/доцент/старший викладач/" +
                                    "викладач/асистент/викладач-стажер) : ");
                            String input = scanner.nextLine();
                        ...
                        while (degree == null) {
                            System.out.println("Введіть науковий ступінь (Доктор філососфії/Доктор наук/не має) : ");
                            String input = scanner.nextLine();
                        ...
                        while (academicTitle == null) {
                            System.out.println("Введіть вчене звання (Доцент/Профеор/Старший науковий співроітник) : ");
                            String input = scanner.nextLine();
                ...
                case 3 -> {
                    ...
                    if(choice == 2){
                        ...
                        Teacher.TeachersAcademicTitle academicTitle = null;
                        while (academicTitle == null) {
                            System.out.println("Введіть нове вчене звання (Доцент/Профеор/Старший науковий співроітник) : ");
                            String input = scanner.nextLine();
